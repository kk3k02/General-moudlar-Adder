...
def modulo_adder(n, a, b, k):  # (A+B) mod (2^n  - K) adder
    # Adding one more bit to n value
    n = n + 1
...
# Testing algorithm for the whole range of A, B and K
# for i in range(0, ((2 ** n) - K)):
#     for j in range(0, ((2 ** n) + K)):
#         result = binary_array_to_int(modulo_adder(n, i, j, K))
#         print(i, "+", j, " mod(", ((2 ** n) - K), ") = ", result)
#         if (i + j) % ((2 ** n) - K) != result:
#             print("Error!")
